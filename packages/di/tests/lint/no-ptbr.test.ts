 ...
 * publishes the README and the changelog to npm — Portuguese there reaches consumers exactly
 * like Portuguese in a `.d.ts` does. Scanning only `.ts` left them unwatched.
 */
